...
namespace LamBelcebur\Rbac\Entity;


use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;
use LamBelcebur\DoctrineORMResources\EntityTrait\Timestamp;
...
class Role
{
     ...
     * @ORM\ManyToMany(targetEntity="LamBelcebur\Rbac\Entity\Role", inversedBy="childRoles")
     ...
     * @var ArrayCollection|Collection
     *
     * @ORM\ManyToMany(targetEntity="LamBelcebur\Rbac\Entity\Role", mappedBy="parentRoles")
     * @ORM\JoinTable(name="role_hierarchy",
    ...
    /**
     * @var ArrayCollection|Collection
     * @ORM\ManyToMany(targetEntity="LamBelcebur\Rbac\Entity\Permission", inversedBy="roles")
